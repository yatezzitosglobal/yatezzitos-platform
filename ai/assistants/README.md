...
| 🌊 Marina | Turista | `turista.md` | 📋 Planificado | Atención a turistas: cotización, reserva, dudas, WhatsApp. [Issue #16](https://github.com/YatezzitosMexico/yatezzitos-platform/issues/16) |
| ⚓ Timón | Propietario | `propietario.md` | 📋 Planificado | Asistencia a propietarios: onboarding, documentos, disponibilidad. [Issue #17](https://github.com/YatezzitosMexico/yatezzitos-platform/issues/17) |
...
| 🔧 Soporte Interno | Equipo | `soporte-interno.md` | 📋 Planificado | IA interna para SEO, copy, marketing, desarrollo. [Issue #18](https://github.com/YatezzitosMexico/yatezzitos-platform/issues/18) |
...
```
Fase 1 (actual):  Orquestador + Reglas globales (AGENTS.md)
Fase 2 (próxima): Marina — Asistente Turista (Issue #16)
Fase 3:           Timón — Asistente Propietario (Issue #17)
Fase 4:           Soporte Interno — Equipo (Issue #18)
