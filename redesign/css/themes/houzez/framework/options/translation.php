...
Redux::setSection( $houzez_opt_name, array(
    ...
    'fields'        => array(
        ...
        **------------------------------------------------------------*/
        ...
        array(
            'id'       => 'spl_ghg_emissions',
            'type'     => 'text',
            'title'    => esc_html__("GHG Emissions Class", 'houzez'),
            'default' => esc_html__("GHG Emissions Class", 'houzez')
        ),

        array(
            'id'       => 'spl_ghg_emissions_index',
            'type'     => 'text',
            'title'    => esc_html__("GHG Emissions", 'houzez'),
            'default' => esc_html__("GHG Emissions", 'houzez')
        ),
        ...
        array(
            'id'       => 'spl_energy_dpe_title',
            'type'     => 'text',
            'title'    => esc_html__("Energy Performance Diagnostic (DPE)", 'houzez'),
            'default' => esc_html__("Energy Performance Diagnostic (DPE)", 'houzez')
        ),

        array(
            'id'       => 'spl_energy_economical_housing',
            'type'     => 'text',
            'title'    => esc_html__("Economical housing", 'houzez'),
            'default' => esc_html__("Economical housing", 'houzez')
        ),

        array(
            'id'       => 'spl_energy_primary_consumption',
            'type'     => 'text',
            'title'    => esc_html__("Primary energy consumption", 'houzez'),
            'default' => esc_html__("Primary energy consumption", 'houzez')
        ),

        array(
            'id'       => 'spl_energy_final',
            'type'     => 'text',
            'title'    => esc_html__("Final energy", 'houzez'),
            'default' => esc_html__("Final energy", 'houzez')
        ),

        array(
            'id'       => 'spl_energy_emissions',
            'type'     => 'text',
            'title'    => esc_html__("Emissions", 'houzez'),
            'default' => esc_html__("Emissions", 'houzez')
        ),

        array(
            'id'       => 'spl_energy_intensive_housing',
            'type'     => 'text',
            'title'    => esc_html__("Energy-intensive housing", 'houzez'),
            'default' => esc_html__("Energy-intensive housing", 'houzez')
        ),

        array(
            'id'       => 'spl_ghg_title',
            'type'     => 'text',
            'title'    => esc_html__("Greenhouse Gas Emissions Index (GHG)", 'houzez'),
            'default' => esc_html__("Greenhouse Gas Emissions Index (GHG)", 'houzez')
        ),

        array(
            'id'       => 'spl_ghg_low_emissions',
            'type'     => 'text',
            'title'    => esc_html__("Low GHG emissions", 'houzez'),
            'default' => esc_html__("Low GHG emissions", 'houzez')
        ),

        array(
            'id'       => 'spl_ghg_high_emissions',
            'type'     => 'text',
            'title'    => esc_html__("High GHG emissions", 'houzez'),
            'default' => esc_html__("High GHG emissions", 'houzez')
        ),

        array(
            'id'       => 'spl_energy_diagnostic_completed',
            'type'     => 'text',
            'title'    => esc_html__("Diagnostic completed", 'houzez'),
            'default' => esc_html__("Diagnostic completed", 'houzez')
        ),
    ...
    'fields'        => array(
        ...
        **------------------------------------------------------------*/
        ...
        array(
            ...
            'default' => esc_html__("YouTube, Vimeo are supported", 'houzez')
        ),
