...
class Favethemes_Menu {
	...
	public function __construct() {
		$this->elementor_blocks = houzez_get_studio_library('mega-menu');
			...
			<div class="fave-items__menu-section">
				...
				<p class="field-menu-item-block description description-wide">
					<label for="edit-menu-item-block-<?php echo esc_attr( $item_id ); ?>">
						<?php esc_html_e('Menu Block', 'houzez'); ?><br>
					...
					<small class="field-instruction"><?php esc_html_e('Choose studio mega menu block for this menu.', 'houzez'); ?></small>
				</p>
			</div>
		</div>
