...
<div class="block-wrap <?php echo esc_attr($is_multi_steps);?>">
	<div class="block-title-wrap d-flex justify-content-between align-items-center">
		<h2><?php esc_html_e('Do you have an account?', 'houzez');?></h2>
	</div>
	<div class="block-content-wrap">
		<p class="step-login-btn mb-4">
		...
		<div class="step-tab-register">
			<div class="row">
				<div class="col-md-6 col-sm-12">
					<div class="mb-3">
						<label class="form-label" for="username"><?php esc_html_e('Username', 'houzez'); ?>* </label>
			    ...
			    <div class="col-md-6 col-sm-12">
				    <div class="mb-3">
				    	<label class="form-label" for="username"><?php esc_html_e('Phone', 'houzez'); ?>* </label>
				...
				<div class="col-md-6 col-sm-12">
					<div class="mb-3">
						<label class="form-label" for="user_email"><?php esc_html_e('Email Address', 'houzez'); ?>* </label>
				...
				<div class="col-md-6 col-sm-12">
					<label class="form-label"><?php esc_html_e('Select your account type', 'houzez'); ?></label>
        ...
        <div class="step-tab-login" style="display: none;">
        	<div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label" for="sp_username"><?php esc_html_e('Username', 'houzez'); ?>* </label>
                        <input type="text" id="sp_username" name="sp_username" class="form-control" placeholder="<?php esc_html_e( 'Enter Your Username', 'houzez' ); ?>">
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label" for="sp_password"><?php esc_html_e('Password', 'houzez'); ?>* </label>
