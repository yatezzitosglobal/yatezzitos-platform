...
<div class="block-wrap">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
          <h5 class="card-title"><?php esc_html_e('Top Countries', 'houzez'); ?></h5>
        </div>
        <?php if( !empty($countries)) { ?>
        <div class="d-flex justify-content-start align-items-center gap-4">
          <div class="d-flex justify-content-center">
            <canvas id="top-countries-doughnut-chart" data-chart='<?php echo json_encode($chart_data); ?>' style="width: 150px; height: 150px;"></canvas>
          </div>
          <ul class="d-flex flex-column flex-grow-1 list-unstyled list-lined" role="list">
            ...
            <li class="mortgage-calculator-data-<?php echo $i; ?> d-flex align-items-center justify-content-between stats-data-<?php echo $i; ?>" role="listitem">
              <div class="list-lined-item w-100 d-flex justify-content-between py-1">	
                <span>
                  <i class="houzez-icon icon-sign-badge-circle me-1" aria-hidden="true"></i> <strong class="text-capitalize"><?php echo esc_attr($country_name); ?></strong> 
                </span>
                <span><?php echo number_format_i18n($country_count); ?> <small><?php echo $count_label; ?></small></span>
              </div>
            </li>
            <?php } ?>
