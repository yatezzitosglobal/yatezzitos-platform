...
if(is_author()) {
	...
	// WPML: Store review with original language post ID to share across all translations
	$listing_id = houzez_get_original_post_id( $post->ID, $review_post_type );
}
...
<div class="block-content-wrap">
	<form method="post">
        ...
        <input type="hidden" name="listing_id" id="review_listing_id" value="<?php echo intval($listing_id); ?>"/>
