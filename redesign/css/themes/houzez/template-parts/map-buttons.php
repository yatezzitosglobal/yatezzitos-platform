...
<div class="map-next-prev-actions">
	...
	<button id="houzez-gmap-view" class="map-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-bs-haspopup="true" aria-bs-expanded="true"><i class="houzez-icon icon-earth-1 me-1"></i> <span><?php esc_html_e( 'View', 'houzez' ); ?></span></button>
	<?php } ?>
...
<div class="map-zoom-actions">
	<div id="<?php echo esc_attr($full_id); ?>" class="map-btn">
		<i class="houzez-icon icon-expand-3 me-1"></i> <span><?php esc_html_e('Fullscreen', 'houzez'); ?></span>
	</div>
