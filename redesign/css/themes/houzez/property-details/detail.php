...
<div class="property-detail-wrap property-section-wrap" id="property-detail-wrap" role="region">
	<div class="block-wrap">
		<div class="block-title-wrap d-flex justify-content-between align-items-center">
			...
			<span class="small-text text-secondary" href="#" target="_blank"><i class="houzez-icon icon-attachment me-1" aria-hidden="true"></i> <?php esc_html_e( 'Updated on', 'houzez' ); ?> <?php the_modified_time('F j, Y'); ?> <?php esc_html_e( 'at', 'houzez' ); ?> <?php the_modified_time('g:i a'); ?></span>
			<?php } ?>
