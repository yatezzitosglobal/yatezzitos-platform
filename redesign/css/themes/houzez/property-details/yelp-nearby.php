...
<div class="property-nearby-wrap property-section-wrap" id="property-nearby-wrap" role="region">
	<div class="block-wrap">
		<div class="block-title-wrap d-flex justify-content-between align-items-center">
			...
			<div class="small text-muted nearby-logo" role="contentinfo"><?php echo esc_html__("Powered by", "houzez"); ?> <i class="houzez-icon icon-social-media-yelp"></i> <strong><?php echo esc_html__("Yelp", "houzez"); ?></strong></div>
